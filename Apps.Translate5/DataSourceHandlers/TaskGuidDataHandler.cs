...
public class TaskGuidDataHandler : Translate5Invocable, IAsyncDataSourceHandler
{
    public TaskGuidDataHandler(InvocationContext invocationContext) : base(invocationContext)
    {
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        return items
            ...
            .Take(40)
            .ToDictionary(x => x.TaskGuid, x => x.TaskName);
    }
}